package com.acciobuild.organization.security.filter;
...
import com.acciobuild.organization.security.OrgUserDetails;
 ...
 * and initializing multi-tenant database contexts.
 */
@Component
        ...
        try {
            if (jwtUtils.validateToken(jwt)) {
                ...
                if (email != null && userIdStr != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    OrgUserDetails principal = new OrgUserDetails(userId, email, organizationId, authorities);
