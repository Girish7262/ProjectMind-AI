package com.acciobuild.project.multitenancy;
...
/**
 * Aspect-oriented filter manager enforcing Hibernate tenant filters on project data lookups.
...
public class TenantAspect {
     ...
     */
    @Before("execution(* com.acciobuild.project.domain.repository..*(..))")
