package com.acciobuild.ai.security.filter;
...
/**
 * Filter that extracts JWT details, binds authentication metadata, and registers TenantContext threads.
 */
@Component
        ...
        try {
            if (jwtUtils.validateToken(jwt)) {
                ...
                if (email != null && userIdStr != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    AiUserDetails principal = new AiUserDetails(userId, email, organizationId, authorities);
