...
import com.acciobuild.ai.security.filter.JwtAuthenticationFilter;
...
/**
 * Spring Security configuration establishing stateless boundaries and method authorization gates.
 */
@Configuration
@EnableWebSecurity
