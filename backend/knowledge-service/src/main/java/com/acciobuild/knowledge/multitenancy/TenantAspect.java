package com.acciobuild.knowledge.multitenancy;
...
/**
 * Aspect-oriented filter manager enforcing Hibernate tenant filters on knowledge data lookups.
...
public class TenantAspect {
     ...
     */
    @Before("execution(* com.acciobuild.knowledge.domain.repository..*(..))")
